...
public class CopyReportResources {
     ...
     public void copyResources() {
         ...
         this.copyFile("src/main/resources/reportResources/pager.css", "test-output/pager.css");
         this.copyFile("src/main/resources/reportResources/pager.js", "test-output/pager.js");

...
import cn.youedata.config.Config;
...
public class TestReport implements IReporter{
	...
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory)
	{
		...
		this.sort(list);
		this.outputResult(list, "test-output"+"/report.html");
	...
	private void outputResult(List<ITestResult> fullResults, String path){
		...
		try {
			...
			sb.append("<link href=\"pager.css\" rel=\"stylesheet\" type=\"text/css\"/>\n");
			...
			sb.append("<script type=\"text/javascript\" src=\"pager.js\"></script>\n");
			sb.append("<script type=\"text/javascript\">\n")
					.append("function bigimg(i)\n"
							...
							+ "i.style.zoom=zoom+'%';\n"
							+ "return false;\n}")
					.append(" $.ajaxSetup ({ cache: false,async: false\n //关闭AJAX相应的缓存\n });\n")
					.append(" $(document).ready(function(){"
							...
							+ "{\n"
							+ "$('<li class=\"passed_info_li\" title=\'+item_text+\'></li>').html(item_text).appendTo('ol');\n"
							+ "}\n"
							+ "else\n"
							+ "{$('<li class=\"failed_info_li\" title=\'+item_text+\'></li>').html(item_text).appendTo('ol');\n"
							+ "}\n"
							+ " });"
							+ " }\n });\n"
			...
			sb.append("<div id=\"report_title\" style=\"margin-top:180px\">\n");
			...
			sb.append("</div>\n");
			sb.append("</div>");
			sb.append("<div  id=\"header_right\" style=\"margin:40px 60px\" >\n");
			sb.append("<div id=\"title\">\n");
			sb.append("<div>" +
					reportTitle +
					"</div>\n");
			sb.append("</div>\n");
			sb.append("<div id=\"canvas_div\"><canvas id=\"canvas\" height=\120\" width=\"120\"></canvas>\n</div>"
					+ "</div>\n");
			...
			sb.append(" <tr>\n<td><div align=\"center\">");
			sb.append("<button id=\"total_num\" onclick=\"getTab('#total')\">");
			...
			sb.append("<tr>\n<td colspan=16 align=\"left\" style=\"color:green;font-size:16px;font-weight:bold\">所有测试用例</td>\n</tr>\n");
			sb.append("<tr class=\"backColor\">\n<td width=\"2%\" class=\"SEQ\">序号</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">项目路径</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">功能模块</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">用例名称</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">测试描述</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">测试操作</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">测试数据</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">预期结果</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">测试组</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">测试执行者</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">计划完成时间</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">执行测试时间</td>\n");
			sb.append("<td width=\"18%\" colspan=2 align=\"left\">测试结果</td>\n");
			sb.append("<td width=\"5%\" class=\"case_time\">耗时</td>\n");
			sb.append("</tr>\n");
			...
			for (int i = 0; i < fullResults.size(); i++) {
				...
				final Object tep = fullResults.get(i).getParameters()[0];
				TestTep testTep = (TestTep)tep;
				...
				if (!fullResults.get(i).getMethod().getDescription().isEmpty())
				{
					if (fullResults.get(i).getParameters().length>0) {
						sb.append("<tr id=\""+testMethodFullName+"."+fullResults.get(i).getEndMillis()+"\" class=\"testCase\">\n");
						sb.append("<td class=\"SEQ\">"+(i+1)+"</td>");
						Object[] parameters=fullResults.get(i).getParameters();
						sb.append("<td class=\"case_funtcion_td\">"+testTep.getProjectPath()+"</td>\n");//项目路径
						sb.append("<td class=\"case_funtcion_td\">"+testTep.getActionName()+"</td>\n");//功能模块
						sb.append("<td class=\"case_name_td\">"+testTep.getTestName()+"</td>\n");//用例名称
						sb.append("<td class=\"case_name_td\">"+testTep.getTestDesc()+"</td>\n");//用例描述
						sb.append("<td class=\"case_name_td\">"+testTep.getOpeartor()+"</td>\n");//测试操作
						sb.append("<td class=\"case_name_td\">"+testTep.getTestData()+"</td>\n");//测试数据
						sb.append("<td class=\"case_name_td\">"+testTep.getExpectResult()+"</td>\n");//预期结果
						sb.append("<td class=\"case_name_td\">"+testTep.getTestTeam()+"</td>\n");//测试组
						sb.append("<td class=\"case_name_td\">"+testTep.getExecuteUser()+"</td>\n");//测试执行者
						sb.append("<td class=\"case_name_td\">"+testTep.getPlanTime()+"</td>\n");//计划完成时间
						sb.append("<td class=\"case_name_td\">"+formatDate(new Date())+"</td>\n");//执行测试时间
					}
					else {
					...
					sb.append(" ").append("<td class=\"case_result_td\">");//测试结果
					if(this.getStatus(fullResults.get(i).getStatus()).equals("pass"))
					{
					...
					else if(this.getStatus(fullResults.get(i).getStatus()).equals("fail"))
					{
			...
			sb.append("<tr>\n<td colspan=16 align=\"left\" style=\"color:green;font-size:16px;font-weight:bold\">成功测试用例</td>\n</tr>\n");
			sb.append("<tr class=\"backColor\">\n<td width=\"2%\" class=\"SEQ\">序号</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">项目路径</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">功能模块</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">用例名称</td>\n");
			...
			for (int i = 0; i < passArrayList.size(); i++)
			{
				...
				Object tep = passArrayList.get(i).getParameters()[0];
				TestTep testTep = (TestTep)tep;
				...
				if (!passArrayList.get(i).getMethod().getDescription().isEmpty()) {
					if (passArrayList.get(i).getParameters().length>0) {
						sb.append("<tr id=\""+testMethodFullName+"."+passArrayList.get(i).getEndMillis()+"\" class=\"testCase\">\n");
						sb.append("<td class=\"SEQ\">"+(i+1)+"</td>");
			...
			sb.append("<tr>\n<td colspan=16 align=\"left\" style=\"color:red;font-size:16px;font-weight:bold\">失败测试用例</td>\n</tr>\n");
			sb.append("<tr class=\"backColor\">");
			...
			for (int j = 0; j < failedArrayList.size(); j++)
			{
				...
				Object tep = failedArrayList.get(j).getParameters()[0];
				TestTep testTep = (TestTep)tep;
				...
				if (!failedArrayList.get(j).getMethod().getDescription().isEmpty()) {
					...
					if (failedArrayList.get(j).getParameters().length>0) {
						sb.append("<tr id=\""+testMethodFullName+"."+failedArrayList.get(j).getEndMillis()+"\" class=\"testCase\">\n");
			...
			sb.append("<tr>\n<td colspan=16 align=\"left\" style=\"color:green;font-size:16px;font-weight:bold\">跳过测试用例</td>\n</tr>\n");
			sb.append("<tr class=\"backColor\">\n<td width=\"2%\" class=\"SEQ\">序号</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">项目路径</td>\n");
			sb.append("<td width=\"5%\" class=\"case_funtcion_td\">功能模块</td>\n");
			sb.append("<td width=\"5%\" class=\"case_name_td\">用例名称</td>\n");
			...
			for (int j = 0; j < skipArrayList.size(); j++)
			{
				...
				final Object tep = skipArrayList.get(j).getParameters()[0];
				TestTep testTep = (TestTep)tep;
				...
				if (!skipArrayList.get(j).getMethod().getDescription().isEmpty()) {
					if (skipArrayList.get(j).getParameters().length>0) {
						sb.append("<tr id=\""+testMethodFullName+"."+skipArrayList.get(j).getEndMillis()+"\" class=\"testCase\">\n");
						sb.append("<td class=\"SEQ\">"+(j+1)+"</td>");
			...
			//--跳过结果--end
			sb.append("</table>\n</div>\n");
			sb.append("<div class=\"ddd\">\n");
			sb.append("<ul class=\"pagination\" id=\"page2\">");
			sb.append("</ul>");
			sb.append("</div>\n");
			sb.append("<span style=\"font-size:14px;margin-top:5px\" >温馨提示：点击按钮展开详情</span>"
